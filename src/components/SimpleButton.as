package components 
{
	...
	{
		static public const BUTTON_PRESSED:String = "buttonPressed";	//Cotntant for Button Click Event
		...
		public function SimpleButton(text:String = "empty") 
		{
			...
			gradientGlow.colors = [0x000000, 0xFFB200];
			...
			this.graphics.lineStyle(2, 0xB24700);
